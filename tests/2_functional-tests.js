  ...
  suite('Routing Tests', function() {
    suite('GET /api/stock-prices => stockData object', function() {
      ...
      test('1 stock', function(done) {
       chai.request(server)
        ...
        .end(function(err, res){
         ...
         assert.equal(res.body.stockData.stock,'CGC');
      ...
      test('1 stock with like', function(done) {
        chai.request(server)
          ...
          .end(function(err,res){
            ...
            //set likes variable to test against double counting
      ...
      test('2 stocks', function(done) {
        chai.request(server)
          ...
          .end(function(err,res){
            ...
            assert.oneOf(res.body.stockData[0].stock,['CGC','APHA'])
            assert.oneOf(res.body.stockData[1].stock,['CGC','APHA'])
      ...
      test('2 stocks with like', function(done) {
        chai.request(server)
          .get('/api/stock-prices')
          .query({stock:['CGC','APHA'],like:true})
          .end(function(err,res){
            assert.equal(res.status,200);
